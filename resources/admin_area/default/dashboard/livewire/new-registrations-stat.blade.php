...
new class extends Component
{
    ...
    {
        return Statistics::newRegistrationsLastDays($this->activeDateRange);
    }
}
...
<div class="col-sm-6 col-lg-3">
    <x-admin::dashboard.metric-stat-card
        title="New Users"
        :value="$this->registrationData['count'] . ' clients'"
        :description="$this->registrationData['count'] . ' new users, compared to ' . $this->registrationData['previous_count'] . ' in the previous period.'"
        :change="$this->registrationData['change_compared_to_previous_period'] ?? 0"
    >
        <x-slot:actions>
            <div class="dropdown">
