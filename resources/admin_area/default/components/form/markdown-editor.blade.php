...
<div class="">
    <div class="" id="editor-div">
        <div class="input-group flex flex-column">
            <div class="input-group-text rounded-top rounded-bottom-0 border-bottom-0" style="white-space: unset;">
                <div class="">
                    <button type="button" class="btn btn-icon" id="editor-text-h1">
                    ...
                    <button type="button" class="btn btn-icon" id="editor-text-h2">
                    ...
                    <button type="button" class="btn btn-icon" id="editor-text-h3">
                ...
                <div class="ms-1">
                    <button type="button" class="btn btn-icon" id="editor-text-bold">
                    ...
                    <button type="button" class="btn btn-icon" id="editor-text-italic">
                    ...
                    <button type="button" class="btn btn-icon" id="editor-text-ul">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-type-underline" viewBox="0 0 16 16">
                            <path d="M5.313 3.136h-1.23V9.54c0 2.105 1.47 3.623 3.917 3.623s3.917-1.518 3.917-3.623V3.136h-1.23v6.323c0 1.49-.978 2.57-2.687 2.57s-2.687-1.08-2.687-2.57zM12.5 15h-9v-1h9z" />
                        </svg>
                    </button>
                    <button type="button" class="btn btn-icon" id="editor-text-quote">
                    ...
                    <button type="button" class="btn btn-icon" id="editor-text-code">
                ...
                <div class="">
                    <button type="button" class="btn btn-icon" id="editor-list-uo">
                    ...
                    <button type="button" class="btn btn-icon" id="editor-list-numbered">
                    ...
                    <button type="button" class="btn btn-icon" id="editor-image">
                    ...
                    <button type="button" class="btn btn-icon" id="editor-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-link-45deg" viewBox="0 0 16 16">
                            <path d="M4.715 6.542 3.343 7.914a3 3 0 1 0 4.243 4.243l1.828-1.829A3 3 0 0 0 8.586 5.5L8 6.086a1 1 0 0 0-.154.199 2 2 0 0 1 .861 3.337L6.88 11.45a2 2 0 1 1-2.83-2.83l.793-.792a4 4 0 0 1-.128-1.287z" />
                            <path d="M6.586 4.672A3 3 0 0 0 7.414 9.5l.775-.776a2 2 0 0 1-.896-3.346L9.12 3.55a2 2 0 1 1 2.83 2.83l-.793.792c.112.42.155.855.128 1.287l1.372-1.372a3 3 0 1 0-4.243-4.243z" />
                        </svg>
                    </button>
{{--                    <button type="button" class="btn" id="editor-link">--}}
{{--                        Preview--}}
{{--                    </button>--}}
                </div>
            </div>
            @if(!$preview)
                <textarea id="editor" class="form-control rounded-bottom rounded-top-0 w-100" {{ $attributes->merge(['rows' => 10]) }} aria-label="With textarea"></textarea>
            @else
...
@section('scripts')
    <script src="{{ admin_asset('js/markdown-editor.js') }}"></script>
@endsection
