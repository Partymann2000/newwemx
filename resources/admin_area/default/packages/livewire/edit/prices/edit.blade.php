...
new class extends Component {
    ...
    public function updatePackagePrice(): void
    {
        $price = Package::actions()->updatePackagePriceAsAdmin([
        ...
        $this->redirect(route('admin.packages.edit', ['package' => $this->package->id, 'packageEditPage' => 'edit_price', 'priceId' => $this->priceId]), true);
    }
    ...
    public function mount($package): void
    {
        ...
        $price = $package->prices()->findOrFail($this->priceId);
        $this->description = $price->short_description;
        $this->period_in_days = $price->period_in_days;
        $this->price = $price->price;
        $this->setup_fee = $price->setup_fee;
        $this->upgrade_fee = $price->upgrade_fee;
    }
}
?>

<form wire:submit="updatePackagePrice()">
    <div class="mb-3">
