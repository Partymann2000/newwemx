...
new class extends Component {
    ...
    {
        $currency = Currency::actions()->createCurrenyAsAdmin([
        ...
        $this->redirect(route('admin.currencies.index'), true);
    }
...
?>
<form class="card" wire:submit="createCurrency()">
    <div class="card-header">
        <h3 class="card-title">{{ __('messages.create_currency') }}</h3>
    </div>
    <div class="card-body">
        <div class="mb-3 row">
